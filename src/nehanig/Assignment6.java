...
public class Assignment6 {
	...
	public void getOptionsFromFirstFrame() throws InterruptedException {
		...
		System.out.println("Step : Sitch to First Frame");
		WebElement frame1 = driver.findElement(By.xpath("//iframe[@name='site1']"));
		
		
		driver.switchTo().frame(frame1);
		System.out.println("Step : Switched to Frame 1");
		Thread.sleep(3000);
		...
		List<WebElement> optionsOnFrame = driver.findElements(By.xpath("//ul[@class='navbar-nav mr-4 mb-2 mb-lg-0 pl-4 pl-lg-2']/li"));
