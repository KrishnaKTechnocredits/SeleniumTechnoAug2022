...
public class Assignment9 {
	...
	public void uploadFile() throws AWTException, InterruptedException {
		...
		driver.findElement(By.xpath("(//div[@class='top-level-menu-item-container'])[2]/a")).click();
		System.out.println("Step4: Click on my info tab");
		//(//a[@class='top-level-menu-item'])[1]
	...
	//	PredefinedActions.scrollViewToElement(driver.findElement(By.xpath("//div[@class='form-div'][2]")));
		...
		StringSelection selectFile = new StringSelection("C:\\Users\\hp\\Desktop\\Vibha document marksheet");
		...
		String expectedFile = "VibhaSawnerSoftwareTestingCVMCA2022Passout(1).pdf";
